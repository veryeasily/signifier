...
*Most client code is located <a href="https://github.com/elju/signifier/blob/master/extension/content-script/signifier.coffee">here</a> with the unconcatenated code in the same directory. The server code is run by node and is located <a href="https://github.com/elju/signifier/blob/master/server/server.coffee">here</a>.*
